  ...
  return (
    <div className="flex flex-col gap-2 w-full">
      <label className="text-sm font-medium text-gray-300">
        Screenshots / mockups{' '}
        <span className="text-gray-500">(optional, up to {MAX_IMAGES})</span>
      </label>
          ...
          {previews.map((p, i) => (
            <div key={p.url} className="relative shrink-0">
              ...
              <button
                ...
                className="absolute -top-1.5 -right-1.5 flex items-center justify-center w-5 h-5 rounded-full bg-gray-900 border border-gray-600 text-gray-300 hover:text-red-400 hover:border-red-400 transition-colors text-xs leading-none"
              >
                ✕
              </button>
            </div>
