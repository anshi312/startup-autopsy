  ...
  return (
    <div className="flex flex-col gap-2 w-full">
      <label className="text-sm font-medium text-gray-300">
        Pitch deck <span className="text-gray-500">(optional)</span>
      </label>

      {file ? (
        <div className="flex items-center justify-between rounded-lg bg-gray-800 border border-gray-700 px-4 py-3">
          <div className="flex items-center gap-3 min-w-0">
            <svg className="shrink-0 text-indigo-400 w-5 h-5" fill="currentColor" viewBox="0 0 24 24">
          ...
          <button
            type="button"
            onClick={remove}
            className="ml-4 shrink-0 text-gray-400 hover:text-red-400 transition-colors text-sm"
        ...
        >
          ...
          <div className="text-center">
            <p className="text-sm text-gray-300">Drop your pitch deck here <span className="text-gray-500">(PDF)</span></p>
